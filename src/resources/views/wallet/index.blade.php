...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('wallet.deposit') }}" method="POST" class="mb-6 bg-white p-6 rounded shadow">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="amount" id="amount" step="0.01" required class="block w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('amount') }}">
        </div>
        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition shadow-md">
            Depositar
        </button>
    </form>
